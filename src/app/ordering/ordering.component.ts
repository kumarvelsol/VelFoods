...
export class OrderingComponent implements OnInit {
  ...
  order_id:number=0;order_tax:number;jsRes :JsResponse;
  order_itemname:any[] =[];
  order_rate:any[] =[];
  order_quantity:any[] =[];
  order_totalamount:any[] =[];
 ...
 ngOnInit() {
  ...
  onsaveclick()
  {
    ...
    else
    {
      ...
      {
        this.order_itemname.push(this.dataSource[i].itemname_item_name);
        this.itemname_id.push(this.dataSource[i].itemname_id);
        this.order_rate.push(this.dataSource[i].order_rate);
        this.order_quantity.push(this.dataSource[i].order_quantity);
        this.order_totalamount.push(this.dataSource[i].order_totalamount);
      }
      ...
      this._roomservice.addingorder(this.table_name,this.table_pax,this.order_itemname,this.order_rate,this.order_quantity,this.order_totalamount,
                                    1,this.itemname_id,this.table_defination_id,this.order_status,this.insert_by,this.insert_date,this.kot_id).subscribe((data : JsResponse) => {
